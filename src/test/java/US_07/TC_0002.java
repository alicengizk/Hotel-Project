...
public class TC_0002 extends TestBase {
    ...
    /*
    Edit hotelroom bölümünde "General Data", "Hotelroom Data bölümünde "Hotel",
    "Code","Name","Locatıon","Description","Price","Room Type","Max Adult Count",
    "Max Children Count" seçenekleri güncellenip "IsAvailable" ikonu tıklanıp "Save"
    Butonuna Tıklanılabilmeli
    ...
    9) "LIST OF HOTELROOMS" listesinin ilk satırındakı "DETAILS" butonuna tıklanır
    (çıkan sayfada "Edit Hotelroom" yazısı görülmeli)
    10) "Edit Hotelroom" bölümünde "General Data", "Hotelroom Data bölümünde "Hotel"
    dropdown butonundan birinci saradaki hotel seçilir
