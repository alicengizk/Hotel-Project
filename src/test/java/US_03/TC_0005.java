...
public class TC_0005 extends TestBase {
    ...
    /*
    "User Data was inserted successfully" alertinin görünürlüğü kontrol edilmeli
    ve OK butonunu kotrol edilip basılmalı
    ...
    Save buttonunun tıklanmalı
    "User Data was inserted successfully" alertinin görüntülendikten sonra OK butonuna basılmalı
     */
